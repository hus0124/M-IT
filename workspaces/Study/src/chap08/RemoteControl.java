 ...
 * 인터페이스에는 생성자, 필드 부분이 없다 . 인터페이스에 선언된 상수 필드는 모두 접근 제한자 부분(public static final이다,)
 * 
 * */
...
public interface RemoteControl {
	...
	//메소드 : 추상, 디폴트 , 정적 
	// 추상 메소드 : public abstract 단어 생략. 반환형 메소드 이름(매개변수...); 선언만 있고 구현 부분이 없는 메소드. 구현 클래스에서 재정의 해주어야 함.
